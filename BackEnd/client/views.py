...
from django.http import request, Http404, response
...
def convert_lead_to_client(request):
    ...
    client = Client.objects.create(
        team=team, name=lead.company, contact_person=lead.contact_person, email=lead.email, phone=lead.phone, website=lead.website, created_by=request.user)
